...
- Apply these conventions to production and test code. Brace placement and logical statement grouping are manual conventions. Do not run automatic formatting or brace fixes to enforce them; preserve intentional inline exceptions. EditorConfig disables IDE0011/IDE0055 diagnostics and preserves single-line blocks/statements.
